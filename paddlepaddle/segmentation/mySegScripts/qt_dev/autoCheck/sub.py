...
class SubPage(QMainWindow):
        ...
        try:
            ...
            if self.ui.useGPURB.isChecked():
                self.net = onnxruntime.InferenceSession(
                    onnx_path_demo, providers=['CUDAExecutionProvider', 'CPUExecutionProvider'], sess_options=sess_options)
                # self.net._reset_session(self.net.get_providers(), self.net.get_provider_options())
            else:
    ...
    def _slot_open_image(self):
        ...
        self.fileNameList = CommonHelper.get_file_list(self.imgPath)  # 获取所有图片名
    ...
    def _slot_update_model(self):
        ...
        try:
            ...
            sess_options.enable_cpu_mem_arena = False
            if self.ui.useGPURB.isChecked():
                self.net = onnxruntime.InferenceSession(path, providers=['CUDAExecutionProvider', 'CPUExecutionProvider'], sess_options=sess_options)
            else:
    ...
    def __set_ui(self):
        ...
        self.setWindowTitle("Coating peeling rate detection")
