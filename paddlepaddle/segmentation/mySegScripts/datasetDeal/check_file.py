...
imgs_path =  r"C:\Users\hp\Desktop\tc_data\150x70\rust4x\imgs"
tag_path =  r"C:\Users\hp\Desktop\tc_data\150x70\rust4x\gtFine"
# a:上一张图片、d:下一张图片, q:退出
...
while(True):
    ...
    img_copy[anno!=0] = img_copy[anno!=0]+(0,0.5,0)
